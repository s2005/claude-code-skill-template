...
1. Go to https://github.com/s2005/skill-template
...
```bash
# Clone the template
git clone https://github.com/s2005/skill-template.git my-awesome-skill
cd my-awesome-skill
...
- Ask in [GitHub Discussions](https://github.com/s2005/skill-template/discussions)
- Open [GitHub Issue](https://github.com/s2005/skill-template/issues)
